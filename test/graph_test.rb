...
class GraphTest < SiliciumTest
  ...
  def test_BST_1
    ...
    assert_equal(g.root,nil)
    g.add(5)
    assert_equal(g.size,1)
    assert_equal(g.search(5).data,5)
    g.add(3)
    assert_equal(g.size,2)
    assert_equal(g.search(3).data,3)
    assert_equal(g.root.left.data,3)
    g.add(4)
    assert_equal(g.size,3)
    assert_equal(g.search(4).data,4)
    assert_equal(g.root.left.right.data,4)
    g.del_elem(3)
    assert_equal(g.size,2)
    assert_equal(g.root.left.data,4)
    g.del_elem(5)
    assert_equal(g.size,1)
    assert_equal(g.root.data,4)
    assert_equal(g.root.right,nil)
    assert_equal(g.root.left,nil)
    g.del_elem(5)
    assert_equal(g.size,1)
    g.del_elem(4)
    assert_equal(g.size,0)
  ...
  def test_BST_2
    ...
    g.del_elem(3)
    assert_equal(g.size,3)
    assert_equal(g.root.right.right.data,4)
    g.del_elem(1)
    assert_equal(g.size,2)
    assert_equal(g.root.data,2)
    assert_equal(g.root.right.data,4)
  end
  ...
  def test_BST_3
    ...
    assert_equal(g.root.data,4)
    g.del_elem(2)
    assert_equal(g.root.left.data,1)
    g.del_elem(7)
    assert_equal(g.root.right.data,8)
  end
  ...
  def test_BST_4
    ...
    g.add(33)
    g.add(39)
    assert_equal(g.size,19)
    g.del_elem(14)
    assert_equal(g.root.left.right.data,12)
    assert_equal(g.root.left.right.right.data,18)
    g.del_elem(24)
    assert_equal(g.root.right.left.left.left,nil)
    g.del_elem(21)
    assert_equal(g.root.data,18)
    assert_equal(g.root.left.right.right,nil)
    g.del_elem(18)
    assert_equal(g.root.data,12)
    assert_equal(g.root.left.right.data,9)
    g.del_elem(39)
    assert_equal(g.root.right.right.right,nil)
  end
